...
const BUILTIN_TOOL_DEFINITIONS: Record<string, BuiltinToolDefinition> = {
  ...
  applypatch: { normalizedName: 'apply_patch', displayName: 'Patch', icon: 'file-pen', kind: 'builtin' },
  patch: { normalizedName: 'patch', displayName: 'Patch', icon: 'file-pen', kind: 'builtin' },
