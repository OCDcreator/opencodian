...
## Corpus Check
- 390 files · ~337,566 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5296 nodes · 12007 edges · 90 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 3387 edges (avg confidence: 0.8)
...
- `persistLocalStreamOutcome()` --calls--> `mapStreamingContentBlocksToMessageContentBlocks()`  [INFERRED]
  /Volumes/SDD2T/obsidian-vault-write/custom-project/opencodian/src/features/chat/runtime/LocalStreamMessagePersistence.ts → /Volumes/SDD2T/obsidian-vault-write/custom-project/opencodian/src/features/chat/runtime/sendPipelineContent.ts
...
Cohesion: 0.01
Nodes (60): AssistantNoticeCardRenderer, ConversationSessionSettingsModal, t(), ModelConfigJsonModal, OpencodeConfigModal, PermissionInlineCardRenderer, optionalTrimmedText(), parseOptionalNumber() (+52 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (47): applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom(), ConversationHydrationRenderBridge, assembleConversationHydrationRuntime() (+39 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (102): AgentInvocationService, ChildSessionGraphService, buildCommandScopedAgent(), cloneConfigObject(), cloneConfigValue(), getCommandScopedAgentId(), getCommandScopedAgentMetadata(), isCommandScopedAgentForCommand() (+94 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (35): OpenCodeCatalogQueryCoordinator, OpenCodeCatalogStateStore, OpenCodeEventSubscriptionCoordinator, isTransientQuestionMutationError(), normalizePermissionRequest(), normalizePermissionResponse(), normalizePermissionToolReference(), normalizeStringArray() (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (30): ActiveTabContextUsageCoordinator, createEmptyTabContextState(), ContextUsageService, ConversationHistoryActionsCoordinator, ConversationHistoryDialogService, ConversationHydrationOutcomeBridge, ConversationLoadRecoveryCoordinator, ConversationSyncBridge (+22 more)
...
Cohesion: 0.02
Nodes (47): AcpClientManager, ConversationTurnViewModelBuilder, getMessageParentId(), getRecordString(), isRecord(), ConversationWriteSerializationService, createConversationWriteSerializationState(), createSdkClient() (+39 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (94): areChatAppearanceSettingsEqual(), diffObject(), getBuiltinThemePresets(), getThemeAppearanceOverridesFromBase(), getThemePresetDefinition(), hasThemeAppearanceOverrides(), mergePartialChatAppearanceSettings(), resolveThemeChatAppearance() (+86 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (19): normalizeConversationSessionSettings(), buildConversationMetaFromStoredRecord(), cloneConversationListDiagnostics(), ConversationMetadataCache, getUtf8ByteLength(), trackTopDiagnosticEntries(), MarkdownAgentWorkspaceService, parseFrontmatter() (+11 more)
...
Cohesion: 0.02
Nodes (12): ChatVisualDemoCoordinator, ChildSessionGraphCoordinator, ComposerContextEventBridge, OpenCodianSettingTab, OpenCodianSettingsView, PendingIndicatorController, SessionTodoDock, getActiveSecondaryTabId() (+4 more)
...
Cohesion: 0.02
Nodes (41): registerBuiltinGlassAdapters(), cloneConversationMetadataOnly(), ConversationFullMessageCache, ConversationLoadRuntimeBridge, getDefaultDebugModuleSettings(), isDebugModuleKey(), normalizeDebugModuleSettings(), normalizeDebugRefreshIntervalMs() (+33 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (65): ConversationNoticeCoordinator, ConversationMessageRenderDelegate, ConversationSyncedUpdateApplyDelegate, ConversationUserMessageRenderDelegate, getIncrementalRenderedMessageUpdate(), ConversationRenderService, ConversationSyncVisiblePostSyncRouter, TrailingAssistantPatchPlanningDelegate (+57 more)
...
Cohesion: 0.04
Nodes (14): ChatHeaderPresenter, PluginRuntimeCoordinator, SettingsServerSection, broadcastModelsLoadedToSettingsViews(), broadcastServerStatusToSettingsViews(), getSettingsViews(), collectRuntimeSkillNames(), createSlashCommandExecutionHost() (+6 more)
...
Cohesion: 0.05
Nodes (13): buildLocalStreamOutcome(), shouldSyncAfterStream(), getStreamedTextContent(), hasVisibleStreamingContent(), mapStreamingContentBlocksToMessageContentBlocks(), SendPipelineTrace, StreamChunkRouter, StreamController (+5 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (23): extractAssistantStructuredTextCopyContent(), resolveAssistantCopyContent(), AssistantErrorRenderer, buildErrorAssistantFooterPayload(), buildNoticeAssistantFooterPayload(), buildPersistedAssistantFooterPayload(), buildPseudoStreamAssistantFooterPayload(), resolvePersistedAssistantFooterStatusLabel() (+15 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (14): buildStreamErrorNotice(), ChatSelectionControlsCoordinator, findCatalogModel(), findCatalogProvider(), pickCatalogDefaultModel(), pickCatalogProviderDefaultModel(), pickCatalogProviderFirstModel(), pickFirstCatalogModel() (+6 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (39): ModelCatalogStateService, assembleModelCatalog(), assembleServerModelCatalog(), filterCatalogToProviderIds(), projectEffectiveCatalog(), resolveProviderAvailabilityProbePlan(), selectProviderProbeModelId(), collectCurrentEnabledProviderIds() (+31 more)
...
Cohesion: 0.04
Nodes (12): buildChatAppearanceCustomCss(), getChatAppearanceBackgroundSizeValue(), getChatAppearanceCssVariables(), getInputPanelGlassRefractionCssVariables(), ChatSurfaceAppearanceCoordinator, ConversationSessionSettingsCoordinator, extractPrimaryFontName(), InputFontLoader (+4 more)
...
Cohesion: 0.07
Nodes (10): AgentCatalogService, SurfaceAgentBuilder, AgentMentionCandidateService, normalizeRuntimeAgents(), loadAgentMentionCandidatesFromComposerCatalog(), loadAgentMentionCandidatesFromSlashCommandMenuItems(), loadAgentSelectionCandidatesFromComposerCatalog(), loadAgentSelectionCandidatesFromSlashCommandMenuItems() (+2 more)
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 46`, `Community 48`?**
  _High betweenness centrality (0.366) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 1` to `Community 32`, `Community 0`, `Community 36`, `Community 5`, `Community 4`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 27`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 12` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 13`, `Community 19`, `Community 20`, `Community 25`, `Community 30`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Are the 497 inferred relationships involving `t()` (e.g. with `.getEmptyConversationTitle()` and `.generateDefaultTitle()`) actually correct?**
  _`t()` has 497 INFERRED edges - model-reasoned connections that need verification._
