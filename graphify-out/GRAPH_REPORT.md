...
## Corpus Check
- 381 files · ~327,505 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5108 nodes · 11529 edges · 84 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 3244 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (72): AssistantNoticeCardRenderer, ChatHeaderPresenter, ConversationCompactionHelpModal, ConversationHistoryDialogService, t(), getRecentLogText(), McpServerEditorModal, McpServerStatusModal (+64 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (57): applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom(), ConversationHydrationRenderBridge, assembleConversationHydrationRuntime() (+49 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (37): ConversationTurnViewModelBuilder, getMessageParentId(), getRecordString(), isRecord(), ConversationWriteSerializationService, createConversationWriteSerializationState(), createSdkClient(), OpenCodeLegacySseStreamReader (+29 more)
...
Cohesion: 0.02
Nodes (101): AgentInvocationService, BackgroundTaskTimelineLaunchService, ChildSessionGraphService, LiquidGlassSettingHelpModal, LocalSidecarProcessInspector, formatMcpSummaryField(), getFirstScalarMcpFallback(), getMcpSummaryFromFields() (+93 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (90): ConversationSessionSettingsModal, areChatAppearanceSettingsEqual(), diffObject(), getBuiltinThemePresets(), getThemeAppearanceOverridesFromBase(), getThemePresetDefinition(), hasThemeAppearanceOverrides(), mergePartialChatAppearanceSettings() (+82 more)
...
Cohesion: 0.02
Nodes (25): ActiveTabContextUsageCoordinator, createEmptyTabContextState(), ContextUsageService, ConversationHydrationOutcomeBridge, ConversationLoadRecoveryCoordinator, ConversationTabLifecycleRecoveryCoordinator, ConversationTabOpenCoordinator, ConversationViewStateService (+17 more)
...
Cohesion: 0.02
Nodes (24): buildChatAppearanceCustomCss(), getChatAppearanceBackgroundSizeValue(), getChatAppearanceCssVariables(), getInputPanelGlassRefractionCssVariables(), ChatSurfaceAppearanceCoordinator, ChildSessionGraphCoordinator, buildConversationMetaFromStoredRecord(), cloneConversationListDiagnostics() (+16 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (15): normalizeConversationSessionSettings(), ChatVisualDemoCoordinator, cloneConversationMetadataOnly(), ConversationFullMessageCache, ConversationHistoryActionsCoordinator, ConversationLoadRuntimeBridge, ConversationSessionSettingsCoordinator, formatDurationMs() (+7 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (34): AgentMentionComposerController, filterAgentMentionCandidates(), findSingleTextEdit(), getEmptyAgentMentionMenuStatus(), isAtomicMentionEditKey(), isPrintableEditKey(), scrollSelectedItemIntoView(), updateTrackedMentionRanges() (+26 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (12): ComposerContextEventBridge, OpenCodianSettingTab, OpenCodianSettingsView, enhanceSettingsDropdowns(), getActiveSecondaryTabId(), getPrimaryTabDefinition(), resolvePrimaryTabId(), resolveSecondaryTabId() (+4 more)
...
Cohesion: 0.04
Nodes (22): BackgroundTaskInlinePanelRenderer, ConversationUserMessageRenderDelegate, StreamController, formatDurationSeconds(), normalizeDurationSeconds(), ThinkingBlockRenderer, ToolCallRenderer, isInternalStructuredOutputTool() (+14 more)
...
Cohesion: 0.03
Nodes (43): ConversationIdentityRuntime, ConversationAssistantMessageRenderDelegate, ConversationMessageRenderDelegate, ConversationSyncedUpdateApplyDelegate, getIncrementalRenderedMessageUpdate(), TrailingAssistantPatchPlanningDelegate, attachOpenCodeAppAgents(), OpenCodeSdkFacade (+35 more)
...
Cohesion: 0.05
Nodes (40): ModelCatalogStateService, assembleModelCatalog(), assembleServerModelCatalog(), filterCatalogToProviderIds(), projectEffectiveCatalog(), resolveProviderAvailabilityProbePlan(), selectProviderProbeModelId(), collectCurrentEnabledProviderIds() (+32 more)
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 32`, `Community 33`, `Community 35`, `Community 38`, `Community 40`, `Community 43`?**
  _High betweenness centrality (0.318) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 1` to `Community 0`, `Community 3`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 24`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 8`, `Community 11`, `Community 14`, `Community 21`, `Community 25`, `Community 29`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Are the 454 inferred relationships involving `t()` (e.g. with `.getEmptyConversationTitle()` and `.generateDefaultTitle()`) actually correct?**
  _`t()` has 454 INFERRED edges - model-reasoned connections that need verification._
