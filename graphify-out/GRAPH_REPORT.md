# Graph Report - /Volumes/SDD2T/obsidian-vault-write/custom-project/opencodian/src  (2026-05-12)

## Corpus Check
- 381 files · ~327,621 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5112 nodes · 11534 edges · 83 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 3242 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (80): AssistantNoticeCardRenderer, ComposerContextEventBridge, ConversationCompactionHelpModal, ConversationSessionSettingsModal, t(), getRecentLogText(), McpServerEditorModal, McpServerStatusModal (+72 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (68): applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom(), buildLocalStreamOutcome(), ConversationAuthoritativeSyncCoordinator (+60 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (117): AgentInvocationService, BackgroundTaskTimelineLaunchService, ChildSessionGraphService, LiquidGlassSettingHelpModal, LocalSidecarProcessInspector, formatMcpSummaryField(), getFirstScalarMcpFallback(), getMcpSummaryFromFields() (+109 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (92): areChatAppearanceSettingsEqual(), diffObject(), getBuiltinThemePresets(), getThemeAppearanceOverridesFromBase(), getThemePresetDefinition(), hasThemeAppearanceOverrides(), mergePartialChatAppearanceSettings(), resolveThemeChatAppearance() (+84 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (35): OpenCodeCatalogQueryCoordinator, OpenCodeCatalogStateStore, OpenCodeEventSubscriptionCoordinator, OpenCodeMessageNormalizationMapper, isTransientQuestionMutationError(), normalizePermissionRequest(), normalizePermissionResponse(), normalizePermissionToolReference() (+27 more)
...
Cohesion: 0.02
Nodes (17): BackgroundTaskCompletionNoticeService, BackgroundTaskIndicatorCoordinator, BackgroundTaskInlinePanelRenderer, BackgroundTaskLiveSignalCoordinator, createBackgroundTaskLiveSignalCoordinatorHost(), BackgroundTaskNoticeStateService, BackgroundTaskStreamTriggerCoordinator, BackgroundTaskTimelineAssemblyService (+9 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (29): ActiveTabContextUsageCoordinator, createEmptyTabContextState(), normalizeConversationSessionSettings(), ContextUsageService, ConversationHydrationOutcomeBridge, assembleConversationLoadRecovery(), ConversationLoadRecoveryCoordinator, createConversationLoadRecoveryHost() (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (14): ConversationNoticeCoordinator, buildCanonicalConversationFingerprintPayload(), cloneSettings(), getDebugTextPreview(), OpenCodeService, expandSessionCommandTemplate(), normalizeSessionCommandPath(), OpenCodeSessionControlOrchestrator (+6 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (13): buildConversationMetaFromStoredRecord(), cloneConversationListDiagnostics(), ConversationMetadataCache, getUtf8ByteLength(), trackTopDiagnosticEntries(), McpConfigService, OpencodeConfigManager, PluginManagementService (+5 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (14): ChatVisualDemoCoordinator, cloneConversationMetadataOnly(), ConversationFullMessageCache, ConversationHistoryActionsCoordinator, ConversationHistoryDialogService, formatDurationMs(), OpenCodianPlugin, OpenCodianStartupCoordinator (+6 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (24): ConversationTurnViewModelBuilder, getMessageParentId(), getRecordString(), isRecord(), ConversationWriteSerializationService, createConversationWriteSerializationState(), createSdkClient(), OpenCodeLegacySseStreamReader (+16 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (29): PermissionInlineCardRenderer, QuestionDock, QuestionDockCoordinator, applyQuestionDockSelection(), getQuestionDockActiveInteractionState(), getQuestionDockDraftAnswers(), sanitizeQuestionDockAnswer(), selectQuestionDockGroup() (+21 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (51): ConversationAuthoritativeMessageMergeCoordinator, ConversationAuthoritativeReloadCoordinator, findLatestInterruptedNotice(), findLatestUserBeforeTimestamp(), getCanonicalMessageParentId(), isInterruptedNoticeMessage(), shouldBypassCanonicalSyncForInterruptedNotice(), shouldPreserveInterruptedNoticeOnSync() (+43 more)
...
Cohesion: 0.03
Nodes (6): ChildSessionGraphCoordinator, ContextRing, OpenCodianSettingTab, OpenCodianSettingsView, PendingIndicatorController, SettingsSectionCoordinator

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (23): BackgroundConversationPostSyncHandoffCoordinator, BackgroundConversationPostSyncRefreshExecutor, ConversationSyncBackgroundPostSyncRouter, ConversationSyncBridge, createConversationSyncBridgePorts(), assembleConversationSyncRuntime(), createConversationSyncHosts(), createConversationSyncServices() (+15 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (21): ConversationUserMessageRenderDelegate, StreamController, formatDurationSeconds(), normalizeDurationSeconds(), ThinkingBlockRenderer, ToolCallRenderer, isInternalStructuredOutputTool(), createStreamState() (+13 more)
...
Cohesion: 0.04
Nodes (6): buildStreamErrorNotice(), ChatSelectionControlsCoordinator, ModelSelectionRuntime, buildModelSelectorDisplayState(), OpenCodePromptRequestBuilder, PermissionModeSelectorCoordinator
...
Cohesion: 0.05
Nodes (24): ContextDetailModal, ContextUsageDisplayService, cloneFormatterConfigValue(), readFormatterConfigValue(), writeFormatterConfigValue(), buildObjectReplacementPatch(), buildProjectAgentOptionsPatch(), buildProjectAgentPermissionPatch() (+16 more)
...
Cohesion: 0.08
Nodes (19): extractRenderableToolMetadata(), OpenCodeToolContentAssembler, resolveOpenCodeToolKind(), resolveToolResultVisibility(), extractStructuredErrorMessage(), getDebugTextPreview(), logAssistantFinalizationDebug(), OpenCodeStreamingFinalizationCoordinator (+11 more)
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 36`, `Community 39`, `Community 41`?**
  _High betweenness centrality (0.365) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 1` to `Community 0`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 23`, `Community 30`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 8` to `Community 0`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 17`, `Community 22`, `Community 25`?**
