# Graph Report - /Volumes/SDD2T/obsidian-vault-write/custom-project/opencodian/src  (2026-05-11)

## Corpus Check
- 381 files · ~322,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5045 nodes · 11361 edges · 88 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 3193 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (57): AssistantNoticeCardRenderer, ConversationCompactionHelpModal, ConversationHistoryDialogService, ConversationSessionSettingsModal, t(), ModelConfigJsonModal, buildModelPickerGroups(), findModelPickerOption() (+49 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (52): applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom(), createBackgroundTaskViewHost(), ConversationHydrationRenderBridge (+44 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (42): ConversationRenderService, ConversationTurnViewModelBuilder, getMessageParentId(), getRecordString(), isRecord(), ConversationWriteSerializationService, createConversationWriteSerializationState(), createSdkClient() (+34 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (87): AgentInvocationService, BackgroundTaskTimelineLaunchService, buildChatAppearanceCustomCss(), LiquidGlassSettingHelpModal, LocalSidecarProcessInspector, formatMcpSummaryField(), getFirstScalarMcpFallback(), getMcpSummaryFromFields() (+79 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (27): ActiveTabContextUsageCoordinator, BackgroundTaskActivationIndicatorCoordinator, createEmptyTabContextState(), ContextUsageService, ConversationHydrationOutcomeBridge, ConversationLoadRecoveryCoordinator, ConversationSessionSignalRuntime, ConversationSessionTabResolver (+19 more)
...
Cohesion: 0.02
Nodes (36): normalizeConversationSessionSettings(), getChatAppearanceBackgroundSizeValue(), getChatAppearanceCssVariables(), getInputPanelGlassRefractionCssVariables(), ChatSurfaceAppearanceCoordinator, ChildSessionGraphCoordinator, cloneConversationMetadataOnly(), ConversationFullMessageCache (+28 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (43): AssistantErrorRenderer, BackgroundConversationAttentionCoordinator, BackgroundConversationPostSyncHandoffCoordinator, BackgroundConversationSignalSyncStateCoordinator, buildLocalStreamOutcome(), ConversationAuthoritativeMessageMergeCoordinator, ConversationAuthoritativeReloadCoordinator, findLatestInterruptedNotice() (+35 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (14): BackgroundTaskCompletionNoticeService, BackgroundTaskIndicatorCoordinator, BackgroundTaskInlinePanelRenderer, BackgroundTaskLiveSignalCoordinator, createBackgroundTaskLiveSignalCoordinatorHost(), BackgroundTaskNoticeStateService, BackgroundTaskStreamTriggerCoordinator, BackgroundTaskTimelineAssemblyService (+6 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (29): cloneFormatterConfigValue(), readFormatterConfigValue(), writeFormatterConfigValue(), MarkdownAgentWorkspaceService, parseFrontmatter(), McpConfigService, OpencodeConfigManager, PluginManagementService (+21 more)
...
Cohesion: 0.02
Nodes (10): ChatHeaderPresenter, ChatVisualDemoCoordinator, ComposerContextEventBridge, ConversationHistoryActionsCoordinator, formatDurationMs(), OpenCodianPlugin, OpenCodianStartupCoordinator, PluginRuntimeCoordinator (+2 more)
...
Cohesion: 0.03
Nodes (58): ConversationIdentityRuntime, ConversationAssistantMessageRenderDelegate, ConversationMessageRenderDelegate, ConversationUserMessageRenderDelegate, getIncrementalRenderedMessageUpdate(), TrailingAssistantPatchPlanningDelegate, buildMessageRenderGroups(), extractTextContent() (+50 more)
...
Cohesion: 0.05
Nodes (12): AgentCatalogService, SurfaceAgentBuilder, AgentMentionCandidateService, normalizeRuntimeAgents(), SettingsAgentsSection, buildHiddenCommandCacheKey(), loadAgentMentionCandidatesFromComposerCatalog(), loadAgentMentionCandidatesFromSlashCommandMenuItems() (+4 more)
...
Cohesion: 0.06
Nodes (19): chooseForkTarget(), ForkTargetModal, McpServerEditorModal, filterModelPickerGroups(), ModelPickerModal, advanceHighlight(), enhanceSettingsDropdownComponent(), enhanceSettingsDropdowns() (+11 more)
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 35`, `Community 41`, `Community 44`, `Community 47`?**
  _High betweenness centrality (0.339) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 1` to `Community 0`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 23`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 2` to `Community 0`, `Community 33`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 18`, `Community 26`?**
