...
## Corpus Check
- 401 files · ~360,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5606 nodes · 12858 edges · 86 communities detected
...
Cohesion: 0.01
Nodes (60): applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom(), createBackgroundTaskViewHost(), getInputPanelGlassRefractionCssVariables() (+52 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (69): AssistantNoticeCardRenderer, renderAssistantPlainTextFallbackContent(), renderAssistantStructuredContent(), t(), McpServerEditorModal, ModelConfigJsonModal, ModelConfigModelListEditor, ModelConfigProviderEditor (+61 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (110): AgentInvocationService, BackgroundTaskTimelineLaunchService, ChildSessionGraphService, collectMarkdownFiles(), loadCommandsFromConfigDir(), loadCommandsFromMdFiles(), parseFrontmatter(), LiquidGlassSettingHelpModal (+102 more)
...
Cohesion: 0.02
Nodes (38): ConversationSessionSignalRuntime, OpenCodeCatalogQueryCoordinator, OpenCodeCatalogStateStore, OpenCodeEventSubscriptionCoordinator, isTransientQuestionMutationError(), normalizePermissionRequest(), normalizePermissionResponse(), normalizePermissionToolReference() (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (30): ActiveTabContextUsageCoordinator, buildStreamErrorNotice(), createEmptyTabContextState(), ContextUsageService, assembleConversationLoadRecovery(), ConversationLoadRecoveryCoordinator, createConversationLoadRecoveryHost(), ConversationNoticeCoordinator (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (99): buildChatAppearanceCustomCss(), getChatAppearanceBackgroundSizeValue(), getChatAppearanceCssVariables(), areChatAppearanceSettingsEqual(), diffObject(), getBuiltinThemePresets(), getThemeAppearanceOverridesFromBase(), getThemePresetDefinition() (+91 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (84): AcpClientManager, registerBuiltinGlassAdapters(), ConversationTurnViewModelBuilder, getMessageParentId(), getRecordString(), isRecord(), ConversationWriteSerializationService, createConversationWriteSerializationState() (+76 more)
...
Cohesion: 0.03
Nodes (35): buildLocalStreamOutcome(), ConversationAuthoritativeMessageMergeCoordinator, ConversationAuthoritativeReloadCoordinator, findLatestInterruptedNotice(), findLatestUserBeforeTimestamp(), getCanonicalMessageParentId(), isInterruptedNoticeMessage(), shouldBypassCanonicalSyncForInterruptedNotice() (+27 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (13): ChatVisualDemoCoordinator, cloneConversationMetadataOnly(), ConversationFullMessageCache, ConversationHistoryActionsCoordinator, ConversationHistoryDialogService, formatDurationMs(), OpenCodianPlugin, OpenCodianStartupCoordinator (+5 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (10): ComposerContextEventBridge, getRecentLogText(), LspStatusRefreshCoordinator, ProjectConfigFileWatcher, SettingsSecuritySection, SettingsServerSection, restartLocalSkillService(), waitMs() (+2 more)
...
Cohesion: 0.03
Nodes (75): ConversationIdentityRuntime, getIncrementalRenderedMessageUpdate(), TrailingAssistantPatchPlanningDelegate, buildMessageRenderGroups(), extractTextContent(), flattenContentBlocks(), injectLiveCompactionDivider(), isMergeableAssistantMessage() (+67 more)
...
- **Why does `t()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 38`, `Community 41`, `Community 43`, `Community 45`?**
  _High betweenness centrality (0.400) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 0` to `Community 3`, `Community 5`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 11` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 33`, `Community 7`, `Community 8`, `Community 14`, `Community 15`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Are the 587 inferred relationships involving `t()` (e.g. with `.getEmptyConversationTitle()` and `.generateDefaultTitle()`) actually correct?**
  _`t()` has 587 INFERRED edges - model-reasoned connections that need verification._
