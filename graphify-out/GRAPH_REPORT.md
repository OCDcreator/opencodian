...
## Corpus Check
- 423 files · ~395,749 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6117 nodes · 11551 edges · 180 communities detected
...
Cohesion: 0.01
Nodes (58): getLocale(), t(), AssistantNoticeCardRenderer, buildInterruptedAssistantNotice(), QuestionInlineCardRenderer, appendQuestionResolutionCard(), appendQuestionResolutionCardFromRenderPlan(), buildQuestionAnswerMarkdown() (+50 more)
...
Cohesion: 0.03
Nodes (24): extractRenderableToolMetadata(), extractStructuredErrorMessage(), extractStructuredErrorName(), getDebugTextPreview(), inferSseEventName(), OpenCodeStreamEventTransformer, parseJsonRecord(), resolveReasoningDurationSeconds() (+16 more)
...
- **Thin community `Community 68`** (23 nodes): `settingsStyleControls.ts`, `SettingsStyleControls`, `.addColorStyleControl()`, `.addNumericControl()`, `.addNumericStyleControl()`, `.clampNumericControlValue()`, `.clampStyleNumber()`, `.clearStyleControlBindings()`, `.commitColorStyleControlValue()`, `.constructor()`, `.createStyleResetSetting()`, `.dispose()`, `.formatNumericControlValue()`, `.getNumericControlInputChars()`, `.getNumericControlPrecision()`, `.isStableNumericControlDraft()`, `.openStyleColorPicker()`, `.parseCssColorToHex()`, `.refreshStyleControlValues()`, `.registerStyleControlBinding()`, `.renderColorStyleControlValue()`, `.resolveCssColorToHex()`, `.resolveStyleColorPickerHex()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (23 nodes): `models.ts`, `ContextUsageService.ts`, `ContextUsageService`, `.applyPreciseUsage()`, `.applyUsageChunk()`, `.applyUsageSnapshot()`, `.beginStream()`, `.buildPreciseTokens()`, `.calculatePercentage()`, `.cloneState()`, `.completeStream()`, `.createState()`, `.finalizeState()`, `.formatCurrency()`, `.formatNumber()`, `.formatPercent()`, `.getContextBreakdown()`, `.getDisplayTokenBreakdown()`, `.getTotalTokens()`, `.resolveContextWindow()`, `.summarize()`, `.syncStateIdentity()`, `getDefaultContextWindow()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 113`** (10 nodes): `AcpClientManager`, `.connect()`, `.disconnect()`, `.dispose()`, `.getProcess()`, `.getState()`, `.listAgents()`, `.loadConfigs()`, `.setActiveSessionId()`, `AcpClientManager.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (10 nodes): `LspStatusIndicator.ts`, `LspStatusIndicator`, `.constructor()`, `.getLabel()`, `.getTone()`, `.getTooltip()`, `.onload()`, `.refreshLocale()`, `.render()`, `.update()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 155`** (6 nodes): `BackgroundConversationPostSyncRefreshExecutor.ts`, `BackgroundConversationPostSyncRefreshExecutor`, `.constructor()`, `.refreshBackgroundConversation()`, `.refreshBackgroundTabConversation()`, `.refreshSignalSyncedBackgroundConversation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (5 nodes): `QuestionResolutionCoordinator.ts`, `QuestionResolutionCoordinator`, `.applyResolvedQuestionState()`, `.constructor()`, `.renderQuestionResolutionCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 2`, `Community 131`, `Community 3`, `Community 5`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 142`, `Community 16`, `Community 17`, `Community 18`, `Community 145`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 29`, `Community 31`, `Community 32`, `Community 35`, `Community 37`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 57`, `Community 58`, `Community 61`, `Community 62`, `Community 64`, `Community 67`, `Community 68`, `Community 71`, `Community 72`, `Community 74`, `Community 77`, `Community 79`, `Community 80`, `Community 82`, `Community 84`, `Community 85`, `Community 94`, `Community 97`, `Community 99`, `Community 106`, `Community 108`, `Community 109`, `Community 110`, `Community 115`, `Community 117`, `Community 118`, `Community 120`, `Community 121`, `Community 124`?**
  _High betweenness centrality (0.475) - this node is a cross-community bridge._
- **Why does `getConversationBackendSessionId()` connect `Community 2` to `Community 32`, `Community 33`, `Community 1`, `Community 70`, `Community 12`, `Community 50`, `Community 83`, `Community 26`, `Community 31`, `Community 61`, `Community 94`, `Community 63`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 1` to `Community 24`, `Community 19`, `Community 5`, `Community 14`?**
