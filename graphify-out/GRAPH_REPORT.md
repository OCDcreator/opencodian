...
## Corpus Check
- 392 files · ~340,835 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5353 nodes · 12172 edges · 82 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 3434 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (70): AssistantNoticeCardRenderer, ConversationHistoryActionsCoordinator, ConversationHistoryDialogService, t(), McpServerEditorModal, ModelConfigJsonModal, buildModelPickerGroups(), filterModelPickerGroups() (+62 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (53): ActiveTabContextUsageCoordinator, buildStreamErrorNotice(), applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom() (+45 more)
...
Cohesion: 0.02
Nodes (21): normalizeConversationSessionSettings(), buildConversationMetaFromStoredRecord(), cloneConversationListDiagnostics(), ConversationMetadataCache, getUtf8ByteLength(), trackTopDiagnosticEntries(), McpConfigService, OpencodeConfigManager (+13 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (40): createBackgroundTaskViewHost(), getChatAppearanceBackgroundSizeValue(), getChatAppearanceCssVariables(), getInputPanelGlassRefractionCssVariables(), ChatSurfaceAppearanceCoordinator, assembleConversationHydrationRuntime(), createConversationHydrationRuntimeBridges(), createConversationHydrationRuntimeViewHosts() (+32 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (92): ConversationSessionSettingsModal, areChatAppearanceSettingsEqual(), diffObject(), getBuiltinThemePresets(), getThemeAppearanceOverridesFromBase(), getThemePresetDefinition(), hasThemeAppearanceOverrides(), mergePartialChatAppearanceSettings() (+84 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (83): AgentInvocationService, BackgroundTaskTimelineLaunchService, buildChatAppearanceCustomCss(), ChildSessionGraphService, LiquidGlassSettingHelpModal, LocalSidecarProcessInspector, formatMcpSummaryField(), getFirstScalarMcpFallback() (+75 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (38): OpenCodeLegacySseStreamReader, extractRenderableToolMetadata(), OpenCodeMessageNormalizationMapper, OpenCodeToolContentAssembler, resolveOpenCodeToolKind(), resolveToolResultVisibility(), expandSessionCommandTemplate(), normalizeSessionCommandPath() (+30 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (83): AcpClientManager, registerBuiltinGlassAdapters(), ConversationTurnViewModelBuilder, getMessageParentId(), getRecordString(), isRecord(), ConversationWriteSerializationService, createConversationWriteSerializationState() (+75 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (31): OpenCodeCatalogQueryCoordinator, OpenCodeCatalogStateStore, OpenCodeEventSubscriptionCoordinator, isTransientQuestionMutationError(), normalizePermissionRequest(), normalizePermissionResponse(), normalizePermissionToolReference(), normalizeStringArray() (+23 more)
...
Cohesion: 0.02
Nodes (43): ChatVisualDemoCoordinator, cloneConversationMetadataOnly(), ConversationFullMessageCache, ConversationLoadRuntimeBridge, getDefaultDebugModuleSettings(), isDebugModuleKey(), normalizeDebugModuleSettings(), normalizeDebugRefreshIntervalMs() (+35 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (77): ConversationAssistantMessageRenderDelegate, ConversationMessageRenderDelegate, ConversationSyncedUpdateApplyDelegate, ConversationUserMessageRenderDelegate, getIncrementalRenderedMessageUpdate(), ConversationRenderService, TrailingAssistantPatchPlanningDelegate, attachOpenCodeAppAgents() (+69 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (36): BackgroundConversationPostSyncHandoffCoordinator, buildLocalStreamOutcome(), ConversationAuthoritativeMessageMergeCoordinator, ConversationAuthoritativeReloadCoordinator, findLatestInterruptedNotice(), findLatestUserBeforeTimestamp(), getCanonicalMessageParentId(), isInterruptedNoticeMessage() (+28 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (10): ComposerContextEventBridge, OpenCodianSettingTab, OpenCodianSettingsView, SettingsAcpSection, getActiveSecondaryTabId(), getPrimaryTabDefinition(), resolvePrimaryTabId(), resolveSecondaryTabId() (+2 more)
...
Cohesion: 0.04
Nodes (9): MarkdownAgentWorkspaceService, parseFrontmatter(), SettingsAgentsSection, StreamController, formatDurationSeconds(), normalizeDurationSeconds(), ThinkingBlockRenderer, ToolCallRenderer (+1 more)
...
Cohesion: 0.04
Nodes (11): SettingsConversationSection, addSettingHelpButton(), applyInlineCodeText(), buildInlineCodeFragment(), createSettingsBlock(), renderLanguageSetting(), renderSettingsPanelTitle(), resolvePluginAssetUrl() (+3 more)
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 38`, `Community 39`, `Community 40`?**
  _High betweenness centrality (0.310) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 10` to `Community 0`, `Community 32`, `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 19`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Are the 513 inferred relationships involving `t()` (e.g. with `.getEmptyConversationTitle()` and `.generateDefaultTitle()`) actually correct?**
  _`t()` has 513 INFERRED edges - model-reasoned connections that need verification._
