...
## Corpus Check
- 379 files · ~325,160 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5063 nodes · 11415 edges · 83 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 3203 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (70): AssistantNoticeCardRenderer, ContextFilePickerModal, ConversationSessionSettingsModal, t(), getRecentLogText(), McpServerEditorModal, ModelConfigJsonModal, ModelConfigModelListEditor (+62 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (65): applyPassiveScrollMeasurement(), applyUserScrollIntent(), getDistanceFromBottom(), getProgrammaticScrollGuardDelayMs(), hasProgrammaticScrollGuard(), isNearBottom(), buildChatAppearanceCustomCss(), getChatAppearanceBackgroundSizeValue() (+57 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (44): ConversationNoticeCoordinator, ConversationWriteSerializationService, createConversationWriteSerializationState(), createSdkClient(), buildCanonicalConversationFingerprintPayload(), cloneSettings(), getDebugTextPreview(), OpenCodeService (+36 more)
...
Cohesion: 0.02
Nodes (25): ActiveTabContextUsageCoordinator, createEmptyTabContextState(), ContextUsageService, ConversationHydrationOutcomeBridge, assembleConversationLoadRecovery(), ConversationLoadRecoveryCoordinator, createConversationLoadRecoveryHost(), ConversationSessionTabResolver (+17 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (116): AgentInvocationService, BackgroundTaskTimelineLaunchService, ChildSessionGraphService, buildComposerInputSubmission(), buildComposerInputSubmissionWithAgentIntents(), decoratePromptSubmissionWithAgentMentions(), decoratePromptSubmissionWithPrimaryAgent(), getExistingMentions() (+108 more)
...
Cohesion: 0.02
Nodes (10): ChatVisualDemoCoordinator, cloneConversationMetadataOnly(), ConversationFullMessageCache, ConversationHistoryActionsCoordinator, ConversationHistoryDialogService, formatDurationMs(), OpenCodianPlugin, OpenCodianStartupCoordinator (+2 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (28): buildLocalStreamOutcome(), ConversationAuthoritativeSyncCoordinator, appendNoticeMessage(), logInterruptedAssistantPersistence(), logInterruptedNoticePersistence(), persistLocalStreamOutcome(), shouldPersistLocalAssistantMessage(), PermissionInlineCardRenderer (+20 more)
...
Cohesion: 0.03
Nodes (51): EffortSelector, formatVariantLabel(), clamp(), createStageLayerElement(), createSvgElement(), estimateProjectionDelta(), formatNumber(), generateFilterId() (+43 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (31): OpenCodeLegacySseStreamReader, extractRenderableToolMetadata(), OpenCodeMessageNormalizationMapper, OpenCodeToolContentAssembler, resolveOpenCodeToolKind(), resolveToolResultVisibility(), extractRenderableToolMetadata(), extractStructuredErrorMessage() (+23 more)
...
Cohesion: 0.04
Nodes (14): BackgroundConversationPostSyncHandoffCoordinator, BackgroundConversationPostSyncRefreshExecutor, ConversationLoadRuntimeBridge, ConversationSyncBackgroundPostSyncRouter, ConversationSyncBridge, createConversationSyncBridgePorts(), assembleConversationSyncRuntime(), createConversationSyncHosts() (+6 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (17): BackgroundTaskInlinePanelRenderer, ConversationAssistantMessageRenderDelegate, ConversationMessageRenderDelegate, ConversationUserMessageRenderDelegate, UserMessageContentRenderer, applyUserMessageTextHighlightSpans(), buildCodeFence(), extractExpandedSkillNames() (+9 more)
...
- **Why does `t()` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 22`, `Community 24`, `Community 28`, `Community 31`, `Community 32`, `Community 38`, `Community 40`, `Community 41`, `Community 42`?**
  _High betweenness centrality (0.334) - this node is a cross-community bridge._
- **Why does `OpenCodianView` connect `Community 1` to `Community 0`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `Community 17`, `Community 22`, `Community 25`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `OpenCodeService` connect `Community 2` to `Community 0`, `Community 32`, `Community 3`, `Community 4`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Are the 447 inferred relationships involving `t()` (e.g. with `.getEmptyConversationTitle()` and `.generateDefaultTitle()`) actually correct?**
  _`t()` has 447 INFERRED edges - model-reasoned connections that need verification._
