...
## Corpus Check
- 423 files · ~396,270 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6124 nodes · 11570 edges · 177 communities detected
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1358 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (67): getLocale(), t(), AssistantNoticeCardRenderer, buildInterruptedAssistantNotice(), buildStreamErrorNotice(), renderAssistantNoticeCardAndFooter(), renderAssistantPlaceholderAsNotice(), renderPersistedAssistantNotice() (+59 more)
...
Cohesion: 0.07
Nodes (1): SettingsClaudeCodeSection
...
- **Thin community `Community 31`** (51 nodes): `OpenCodeCatalogQueryCoordinator.ts`, `OpenCodeCatalogQueryCoordinator`, `.addMcpServer()`, `.authenticateMcp()`, `.authorizeProviderOAuth()`, `.buildOpenCodeToolIdentityContext()`, `.clearToolSchemaCacheIfScopeChanged()`, `.completeMcpAuth()`, `.completeProviderOAuth()`, `.connectMcpServer()`, `.constructor()`, `.disconnectMcpServer()`, `.findFiles()`, `.findSymbols()`, `.findText()`, `.getAvailableModels()`, `.getCurrentProject()`, `.getFileStatus()`, `.getFormatterStatus()`, `.getLspStatus()`, `.getPaths()`, `.getProviderAuthMethods()`, `.getProviderDirectory()`, `.getResolvedModelConfig()`, `.getToolCatalogScopeKey()`, `.getToolCatalogSnapshot()`, `.getToolSchemaCacheKey()`, `.getVcsDiff()`, `.getVcsInfo()`, `.initializeProjectGit()`, `.listFiles()`, `.listProjects()`, `.listTools()`, `.logCatalogRequest()`, `.logProviderCatalogResponse()`, `.logResolvedModelConfigResponse()`, `.normalizeAvailableModels()`, `.normalizeDebugReason()`, `.normalizeProviderDefaults()`, `.normalizeProviderDirectory()`, `.normalizeResolvedModelConfigData()`, `.normalizeSingleMcpServerStatus()`, `.normalizeToolCatalogEntries()`, `.observeRuntimeToolNames()`, `.readFile()`, `.refreshMcpServerStatus()`, `.refreshToolIds()`, `.removeMcpAuth()`, `.startMcpAuth()`, `.storeMcpServerStatus()`, `.updateProject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (51 nodes): `SettingsClaudeCodeSection.ts`, `SettingsClaudeCodeSection`, `.applyClaudeModel()`, `.applyClaudePermissionMode()`, `.attach()`, `.attachTabbed()`, `.constructor()`, `.describeRuntimePlugins()`, `.describeRuntimeSkills()`, `.formatDiagnostics()`, `.getClaudeAdapter()`, `.isKnownClaudeTabId()`, `.parseEnv()`, `.parseLineList()`, `.parseNullablePositiveInteger()`, `.parseNullablePositiveNumber()`, `.refreshProjectSourceStatus()`, `.reloadClaudeMcpServers()`, `.renderAdditionalDirectories()`, `.renderAllowedToolsSetting()`, `.renderContextSourcesTab()`, `.renderDiagnostics()`, `.renderDisallowedToolsSetting()`, `.renderEffortSetting()`, `.renderEnvironmentHint()`, `.renderEnvironmentVariablesSetting()`, `.renderExecutableSetting()`, `.renderFallbackModelSetting()`, `.renderLimitsTab()`, `.renderMaxBudgetSetting()`, `.renderMaxTurnsSetting()`, `.renderMcpRuntimeControls()`, `.renderModelSetting()`, `.renderModelThinkingTab()`, `.renderPermissionModeSetting()`, `.renderPermissionsTab()`, `.renderProjectSourceStatus()`, `.renderRuntimeBoundaryNotice()`, `.renderRuntimeEcosystemStatus()`, `.renderRuntimeTab()`, `.renderSdkFoundationOptions()`, `.renderSdkFoundationsTab()`, `.renderSettingSources()`, `.renderTabContent()`, `.renderThinkingBudgetSetting()`, `.renderThinkingSetting()`, `.renderToolsTab()`, `.restartClaudePersistentQueries()`, `.saveSettings()`, `.updateMcpRuntimeStatus()`, `.updateSettingSource()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 140`** (7 nodes): `permission.ts`, `SessionPermissionTracker`, `.addSessionApproval()`, `.clearAll()`, `.clearSession()`, `.isSessionApproved()`, `.makeKey()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (7 nodes): `ModifiedFilesSidebarHelpModal.ts`, `ModifiedFilesSidebarHelpModal`, `.constructor()`, `.createCard()`, `.createTipsCard()`, `.onClose()`, `.onOpen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `t()` connect `Community 0` to `Community 129`, `Community 130`, `Community 3`, `Community 4`, `Community 1`, `Community 2`, `Community 9`, `Community 13`, `Community 141`, `Community 15`, `Community 14`, `Community 16`, `Community 144`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 35`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 51`, `Community 57`, `Community 59`, `Community 62`, `Community 63`, `Community 65`, `Community 68`, `Community 71`, `Community 72`, `Community 74`, `Community 76`, `Community 79`, `Community 80`, `Community 82`, `Community 83`, `Community 86`, `Community 93`, `Community 98`, `Community 106`, `Community 107`, `Community 108`, `Community 114`, `Community 115`, `Community 117`, `Community 118`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.494) - this node is a cross-community bridge._
- **Why does `getConversationBackendSessionId()` connect `Community 2` to `Community 64`, `Community 1`, `Community 96`, `Community 69`, `Community 6`, `Community 12`, `Community 81`, `Community 51`, `Community 93`, `Community 24`, `Community 62`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `getToolIdentity()` connect `Community 5` to `Community 34`, `Community 28`, `Community 58`, `Community 47`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Are the 647 inferred relationships involving `t()` (e.g. with `.getEmptyConversationTitle()` and `.generateDefaultTitle()`) actually correct?**
  _`t()` has 647 INFERRED edges - model-reasoned connections that need verification._
