...
### [DONE] Task 1 - Verify the `ServerManager` hotspot delta, record the next manual target order, and stop the queue cleanly
...
- Queue is closed for this lane; no additional automatic backlog items are defined here.
