...
- `npm run check:owner-guard` must pass.
...
- Use `npm run verify` as the default local pre-merge command; it now includes owner-guard, module-doc, and graphify freshness gates.
