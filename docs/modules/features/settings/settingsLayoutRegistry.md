...
2026-09-18（R-C1）：conversation 主 tab 的 secondary tabs 新增 `vault-retrieval`（backend 无关，不设 `backendRequired`）。
...
| `debug` | `plugin`, `opencode`, `codex`, `claude-code`, `export`, `capability-lab` |
