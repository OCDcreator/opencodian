...
- Debug section 的 OpenCode diagnostics port factory；renderer 只在 composition 边界把 `createOpenCodeTraceDiagnosticsPort()` 注入 `SettingsDebugSection`
