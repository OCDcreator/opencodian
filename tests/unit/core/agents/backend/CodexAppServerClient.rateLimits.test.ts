/**
 * Real unit tests for CodexAppServerClient.getAccountRateLimits().
 *
...
describe('CodexAppServerClient.getAccountRateLimits', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('returns rate limits from app-server response', async () => {
