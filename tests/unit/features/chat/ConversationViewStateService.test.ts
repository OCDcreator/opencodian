...
type MockedConversationHydrationOutcomePort = jest.Mocked<ConversationHydrationOutcomePort>;

function createConversationHydrationOutcomeBridge(): MockedConversationHydrationOutcomePort {
  return {
