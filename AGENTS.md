...
This project is indexed by GitNexus as **opencodian** (37032 symbols, 83792 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
